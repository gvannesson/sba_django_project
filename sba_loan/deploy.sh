...
IMAGE_NAME="sba_loan-django-web"  # Nom de l'image Docker
CONTAINER_NAME="sthorez-sba-loan-django-web-container-autodeploy"  # Nom du conteneur
...
az container create \
    ...
    --ip-address public \
    --ports $PORT \
    --environment-variables SECRET_KEY=$SECRET_KEY DB_HOST=$DB_HOST API_USERNAME=$API_USERNAME API_PASSWORD=$API_PASSWORD BASE_URL=$BASE_URL TOKEN=$TOKEN DB_NAME=$DB_NAME DB_USERNAME=$DB_USERNAME DB_PASSWORD=$DB_PASSWORD DB_PORT=$DB_PORT DJANGO_ALLOWED_HOSTS=$DJANGO_ALLOWED_HOSTS DJANGO_LOGLEVEL=$DJANGO_LOGLEVEL DEBUG=$DEBUG LOCAL=$LOCAL \
